...
namespace DataExtractorMod {
	...
	{
        string IMod.Name => "Data Extractor Mod By ItsDesm";
        ...
        */
        ...
        public string MakeLabJsonObject(
            string name,
            string category,
            string workers,
            string maintenance_cost_units,
        ...
        public string MakeStorageJsonObject(
            string name,
            string category,
            string capacity,
            string workers,
        ...
        public string MakeServerJsonObject (
            string name, 
            string category, 
            string workers,
            string maintenance_cost_units,
            ...
            */
            ...
            foreach (CargoDepotModuleProto item in cargoModules)
            {
                ...
                try
                {
                    ...
                    string machineJson = MakeStorageJsonObject(
                        name,
                        category,
                        capacity,
                        workers,
            ...
            foreach (ResearchLabProto item in labs)
            {
                ...
                try
                {
                    ...
                    Log.Info("Name :" + item.Strings.Name.ToString());
                    string name = item.Strings.Name.ToString();
                    string category = "";
                    string workers = item.Costs.Workers.ToString();
                    string maintenance_cost_units = item.Costs.Maintenance.Product.Strings.Name.ToString();
                    ...
                    if ( item.Id.ToString() != "ResearchLab1"){
                        ...
                        recipes = $"{{\"duration\":{item.DurationForRecipe.Seconds},{inputsObj + outputsObj}}}";
                    ...
                    string machineJson = MakeLabJsonObject(
                        name,
                        category,
                        workers,
                        maintenance_cost_units,
            ...
            foreach (ServerRackProto machine in dataRack)
            {
                ...
                try
                {
                    ...
                    string machineJson = MakeServerJsonObject(
                        name,
                        category,
                        workers,
                        maintenance_cost_units,
